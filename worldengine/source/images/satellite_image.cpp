...
static const std::unordered_map<Biomes, boost::gil::rgb8_pixel_t>
   biomeSatelliteColors_ = {{Biomes::Ocean, {23, 94, 145}},
                            {Biomes::Sea, {23, 94, 145}},
                            {Biomes::Ice, {255, 255, 255}},
                            {Biomes::SubpolarDryTundra, {186, 199, 206}},
                            {Biomes::SubpolarMoistTundra, {186, 195, 202}},
                            {Biomes::SubpolarWetTundra, {186, 195, 204}},
                            {Biomes::SubpolarRainTundra, {186, 200, 210}},
                            {Biomes::PolarDesert, {182, 195, 201}},
                            {Biomes::BorealDesert, {132, 146, 143}},
                            {Biomes::CoolTemperateDesert, {183, 163, 126}},
                            {Biomes::WarmTemperateDesert, {166, 142, 104}},
                            {Biomes::SubtropicalDesert, {205, 181, 137}},
                            {Biomes::TropicalDesert, {203, 187, 153}},
                            {Biomes::BorealRainForest, {21, 29, 8}},
                            {Biomes::CoolTemperateRainForest, {25, 34, 15}},
                            {Biomes::WarmTemperateRainForest, {19, 28, 7}},
                            {Biomes::SubtropicalRainForest, {48, 60, 24}},
                            {Biomes::TropicalRainForest, {21, 38, 6}},
                            {Biomes::BorealWetForest, {6, 17, 11}},
                            {Biomes::CoolTemperateWetForest, {6, 17, 11}},
                            {Biomes::WarmTemperateWetForest, {44, 48, 19}},
                            {Biomes::SubtropicalWetForest, {23, 36, 10}},
                            {Biomes::TropicalWetForest, {23, 36, 10}},
                            {Biomes::BorealMoistForest, {31, 39, 18}},
                            {Biomes::CoolTemperateMoistForest, {31, 39, 18}},
                            {Biomes::WarmTemperateMoistForest, {36, 42, 19}},
                            {Biomes::SubtropicalMoistForest, {23, 31, 10}},
                            {Biomes::TropicalMoistForest, {24, 36, 11}},
                            {Biomes::WarmTemperateDryForest, {52, 51, 30}},
                            {Biomes::SubtropicalDryForest, {53, 56, 30}},
                            {Biomes::TropicalDryForest, {54, 60, 30}},
                            {Biomes::BorealDryScrub, {73, 70, 61}},
                            {Biomes::CoolTemperateDesertScrub, {80, 58, 44}},
                            {Biomes::WarmTemperateDesertScrub, {92, 81, 49}},
                            {Biomes::SubtropicalDesertScrub, {68, 57, 35}},
                            {Biomes::TropicalDesertScrub, {107, 87, 60}},
                            {Biomes::CoolTemperateSteppe, {95, 82, 50}},
                            {Biomes::WarmTemperateThornScrub, {77, 81, 48}},
                            {Biomes::SubtropicalThornWoodland, {27, 40, 12}},
                            {Biomes::TropicalThornWoodland, {40, 62, 15}},
